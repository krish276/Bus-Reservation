...
public class TicketReservationService {
	...
	@Transactional
	public ReservationDetails makeReservation(PassengerListDTO passengers) {
		 ...
		 if(noOfPassengers<bus.getSeatsFree()) {
			 ...
			 ReservationDetails r=dao.insertToDatabase(reserv);//inserting and getting reservid to set in passengers
			 //for guest users
			 int i=0;
